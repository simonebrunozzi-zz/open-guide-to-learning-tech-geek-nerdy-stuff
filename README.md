...
2) You can propose a new "link", by actually simply adding $category: $succint_description $link (e.g. Video games and AI: http://togelius.blogspot.com/2016/01/why-video-games-are-essential-for.html)
If your link points to a discussion, which then points to the actual resource, such as in the case of a Hacker News discussion, you can simply write this: #category: $succint_description $link-to-discussion and $link-to-resource (e.g. Berkeley AI Materials: https://news.ycombinator.com/item?id=10929985 and http://ai.berkeley.edu/project_overview.html)
...
PostgreSQL command line: https://news.ycombinator.com/item?id=10458866 and 
...
Security : https://news.ycombinator.com/item?id=9545972 and http://99percentinvisible.org/episode/perfect-security/
